...
from klippa_ocr_api.models.identity_document_body import IdentityDocumentBody  # noqa: E501
from klippa_ocr_api.rest import ApiException

class TestIdentityDocumentBody(unittest.TestCase):
    """IdentityDocumentBody unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IdentityDocumentBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = klippa_ocr_api.models.identity_document_body.IdentityDocumentBody()  # noqa: E501
        if include_optional :
            return IdentityDocumentBody(
                data = klippa_ocr_api.models.full_identity_document.FullIdentityDocument(
                    parsed = klippa_ocr_api.models.identity_document.IdentityDocument(
                        date_of_birth = klippa_ocr_api.models.identity_document_string_value.IdentityDocumentStringValue(
                            value = '0', ), 
                        date_of_expiry = klippa_ocr_api.models.identity_document_string_value.IdentityDocumentStringValue(
                            value = '0', ), 
                        date_of_issue = klippa_ocr_api.models.identity_document_string_value.IdentityDocumentStringValue(
                            value = '0', ), 
                        document_number = klippa_ocr_api.models.identity_document_string_value.IdentityDocumentStringValue(
                            value = '0', ), 
                        document_subtype = klippa_ocr_api.models.identity_document_string_value.IdentityDocumentStringValue(
                            value = '0', ), 
                        document_type = klippa_ocr_api.models.identity_document_string_value.IdentityDocumentStringValue(
                            value = '0', ), 
                        face = klippa_ocr_api.models.identity_document_image.IdentityDocumentImage(
                            image = '0', 
                            value = '0', ), 
                        gender = klippa_ocr_api.models.identity_document_string_value.IdentityDocumentStringValue(
                            value = '0', ), 
                        given_names = klippa_ocr_api.models.identity_document_string_value.IdentityDocumentStringValue(
                            value = '0', ), 
                        height = klippa_ocr_api.models.identity_document_string_value.IdentityDocumentStringValue(
                            value = '0', ), 
                        identity_document = [
                            klippa_ocr_api.models.identity_document_image_and_value.IdentityDocumentImageAndValue(
                                image = '0', 
                                value = '0', )
                            ], 
                        issuing_country = klippa_ocr_api.models.identity_document_string_value.IdentityDocumentStringValue(
                            value = '0', ), 
                        issuing_institution = klippa_ocr_api.models.identity_document_string_value.IdentityDocumentStringValue(
                            value = '0', ), 
                        mrz = klippa_ocr_api.models.identity_document_string_value.IdentityDocumentStringValue(
                            value = '0', ), 
                        mrz_full_checksum = klippa_ocr_api.models.identity_document_string_value.IdentityDocumentStringValue(
                            value = '0', ), 
                        nationality = klippa_ocr_api.models.identity_document_string_value.IdentityDocumentStringValue(
                            value = '0', ), 
                        personal_number = klippa_ocr_api.models.identity_document_string_value.IdentityDocumentStringValue(
                            value = '0', ), 
                        place_of_birth = klippa_ocr_api.models.identity_document_string_value.IdentityDocumentStringValue(
                            value = '0', ), 
                        residency = klippa_ocr_api.models.identity_document_string_value.IdentityDocumentStringValue(
                            value = '0', ), 
                        signature = klippa_ocr_api.models.identity_document_image.IdentityDocumentImage(
                            image = '0', 
                            value = '0', ), 
                        surname = klippa_ocr_api.models.identity_document_string_value.IdentityDocumentStringValue(
                            value = '0', ), ), 
                    raw_text = '0', ), 
                request_id = '0', 
                result = '0'
    ...
    def testIdentityDocumentBody(self):
        """Test IdentityDocumentBody"""
