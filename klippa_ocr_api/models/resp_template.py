...
class RespTemplate(object):
    ...
    def __init__(self, title=None, local_vars_configuration=None):  # noqa: E501
        """RespTemplate - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def title(self):
        """Gets the title of this RespTemplate.  # noqa: E501

        The name of the template  # noqa: E501

        :return: The title of this RespTemplate.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this RespTemplate.

        The name of the template  # noqa: E501

        :param title: The title of this RespTemplate.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RespTemplate):
            return False
