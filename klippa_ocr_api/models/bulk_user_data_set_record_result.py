...
class BulkUserDataSetRecordResult(object):
    ...
    def __init__(self, action=None, external_id=None, failure_code=None, failure_message=None, item=None, result=None, local_vars_configuration=None):  # noqa: E501
        """BulkUserDataSetRecordResult - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def action(self):
        """Gets the action of this BulkUserDataSetRecordResult.  # noqa: E501

        The action that was performed.  # noqa: E501

        :return: The action of this BulkUserDataSetRecordResult.  # noqa: E501
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        """Sets the action of this BulkUserDataSetRecordResult.

        The action that was performed.  # noqa: E501

        :param action: The action of this BulkUserDataSetRecordResult.  # noqa: E501
        :type: str
        """
    ...
    def external_id(self):
        """Gets the external_id of this BulkUserDataSetRecordResult.  # noqa: E501

        The ID on the external user record this data set belongs to.  # noqa: E501

        :return: The external_id of this BulkUserDataSetRecordResult.  # noqa: E501
        :rtype: str
        """
    ...
    def external_id(self, external_id):
        """Sets the external_id of this BulkUserDataSetRecordResult.

        The ID on the external user record this data set belongs to.  # noqa: E501

        :param external_id: The external_id of this BulkUserDataSetRecordResult.  # noqa: E501
        :type: str
        """
    ...
    def failure_code(self):
        """Gets the failure_code of this BulkUserDataSetRecordResult.  # noqa: E501

        The code when Result is failure. 1: internal error 2: item exists (when doing a create) 3: item does not exist (when doing update or delete)  # noqa: E501

        :return: The failure_code of this BulkUserDataSetRecordResult.  # noqa: E501
        :rtype: int
        """
    ...
    def failure_code(self, failure_code):
        """Sets the failure_code of this BulkUserDataSetRecordResult.

        The code when Result is failure. 1: internal error 2: item exists (when doing a create) 3: item does not exist (when doing update or delete)  # noqa: E501

        :param failure_code: The failure_code of this BulkUserDataSetRecordResult.  # noqa: E501
        :type: int
        """
    ...
    def failure_message(self):
        """Gets the failure_message of this BulkUserDataSetRecordResult.  # noqa: E501

        The message when Result is failure.  # noqa: E501

        :return: The failure_message of this BulkUserDataSetRecordResult.  # noqa: E501
        :rtype: str
        """
    ...
    def failure_message(self, failure_message):
        """Sets the failure_message of this BulkUserDataSetRecordResult.

        The message when Result is failure.  # noqa: E501

        :param failure_message: The failure_message of this BulkUserDataSetRecordResult.  # noqa: E501
        :type: str
        """
    ...
    @property
    def item(self):
        """Gets the item of this BulkUserDataSetRecordResult.  # noqa: E501


        :return: The item of this BulkUserDataSetRecordResult.  # noqa: E501
        :rtype: UserDataSetRecord
        """
        return self._item

    @item.setter
    def item(self, item):
        """Sets the item of this BulkUserDataSetRecordResult.


        :param item: The item of this BulkUserDataSetRecordResult.  # noqa: E501
    ...
    @property
    def result(self):
        """Gets the result of this BulkUserDataSetRecordResult.  # noqa: E501

        The result of the action.  # noqa: E501

        :return: The result of this BulkUserDataSetRecordResult.  # noqa: E501
        :rtype: str
        """
        return self._result
    ...
    def result(self, result):
        """Sets the result of this BulkUserDataSetRecordResult.

        The result of the action.  # noqa: E501

        :param result: The result of this BulkUserDataSetRecordResult.  # noqa: E501
        :type: str
        """
        allowed_values = ["created", "updated", "deleted", "no-change", "failure"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkUserDataSetRecordResult):
            return False
