...
from klippa_ocr_api.models.update_sub_key_body import UpdateSubKeyBody  # noqa: E501
from klippa_ocr_api.rest import ApiException

class TestUpdateSubKeyBody(unittest.TestCase):
    """UpdateSubKeyBody unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test UpdateSubKeyBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = klippa_ocr_api.models.update_sub_key_body.UpdateSubKeyBody()  # noqa: E501
        if include_optional :
            return UpdateSubKeyBody(
                data = klippa_ocr_api.models.key.Key(
