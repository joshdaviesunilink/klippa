...
from klippa_ocr_api.models.full_identity_document import FullIdentityDocument  # noqa: E501
from klippa_ocr_api.rest import ApiException

class TestFullIdentityDocument(unittest.TestCase):
    """FullIdentityDocument unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test FullIdentityDocument
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = klippa_ocr_api.models.full_identity_document.FullIdentityDocument()  # noqa: E501
        if include_optional :
            return FullIdentityDocument(
    ...
    def testFullIdentityDocument(self):
        """Test FullIdentityDocument"""
