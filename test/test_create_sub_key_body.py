...
from klippa_ocr_api.models.create_sub_key_body import CreateSubKeyBody  # noqa: E501
from klippa_ocr_api.rest import ApiException

class TestCreateSubKeyBody(unittest.TestCase):
    """CreateSubKeyBody unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CreateSubKeyBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = klippa_ocr_api.models.create_sub_key_body.CreateSubKeyBody()  # noqa: E501
        if include_optional :
