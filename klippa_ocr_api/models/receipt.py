...
class Receipt(object):
    ...
    openapi_types = {
        ...
        'merchant_chain_liability_amount': 'int',
    ...
    attribute_map = {
        ...
        'merchant_chain_liability_amount': 'merchant_chain_liability_amount',
    ...
    def __init__(self, amount=None, amount_change=None, amount_shipping=None, amountexvat=None, barcodes=None, currency=None, customer_address=None, customer_bank_account_number=None, customer_bank_account_number_bic=None, customer_city=None, customer_coc_number=None, customer_country=None, customer_email=None, customer_house_number=None, customer_municipality=None, customer_name=None, customer_number=None, customer_phone=None, customer_province=None, customer_reference=None, customer_street_name=None, customer_vat_number=None, customer_website=None, customer_zipcode=None, date=None, document_language=None, document_subject=None, document_type=None, hash=None, hash_duplicate=None, invoice_number=None, invoice_type=None, lines=None, matched_keywords=None, matched_lineitems=None, matched_purchase_order_id=None, merchant_address=None, merchant_bank_account_number=None, merchant_bank_account_number_bic=None, merchant_bank_domestic_account_number=None, merchant_bank_domestic_bank_code=None, merchant_chain_liability_amount=None, merchant_chain_liability_bank_account_number=None, merchant_city=None, merchant_coc_number=None, merchant_country=None, merchant_country_code=None, merchant_email=None, merchant_house_number=None, merchant_id=None, merchant_main_activity_code=None, merchant_municipality=None, merchant_name=None, merchant_phone=None, merchant_province=None, merchant_street_name=None, merchant_vat_number=None, merchant_website=None, merchant_zipcode=None, order_number=None, package_number=None, payment_auth_code=None, payment_card_account_number=None, payment_card_bank=None, payment_card_issuer=None, payment_card_number=None, payment_due_date=None, payment_slip_code=None, payment_slip_customer_number=None, payment_slip_reference_number=None, paymentmethod=None, purchasedate=None, purchasetime=None, raw_text=None, receipt_number=None, server=None, shop_number=None, table_group=None, table_number=None, terminal_number=None, transaction_number=None, transaction_reference=None, vat_context=None, vatamount=None, vatitems=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._merchant_chain_liability_amount = None
        ...
        if merchant_chain_liability_amount is not None:
            self.merchant_chain_liability_amount = merchant_chain_liability_amount
    ...
    @property
    def amount_shipping(self):
        """Gets the amount_shipping of this Receipt.  # noqa: E501

        The shipping cost, in cents  # noqa: E501

        :return: The amount_shipping of this Receipt.  # noqa: E501
        :rtype: int
        """
        return self._amount_shipping

    @amount_shipping.setter
    def amount_shipping(self, amount_shipping):
        """Sets the amount_shipping of this Receipt.

        The shipping cost, in cents  # noqa: E501

        :param amount_shipping: The amount_shipping of this Receipt.  # noqa: E501
        :type: int
        """

        self._amount_shipping = amount_shipping
    ...
    def document_type(self, document_type):
        ...
        :type: str
        """
        allowed_values = ["", "invoice", "receipt", "bank_transaction", "bank_overview", "parking", "petrol", "ticket", "boarding_pass", "booking_payment_confirmation", "other"]  # noqa: E501
    ...
    @property
    def merchant_chain_liability_amount(self):
        """Gets the merchant_chain_liability_amount of this Receipt.  # noqa: E501

        The amount that is due on the Chain Liability G-Account (Wet Ketenaansprakelijkheid G-rekening)  # noqa: E501

        :return: The merchant_chain_liability_amount of this Receipt.  # noqa: E501
        :rtype: int
        """
        return self._merchant_chain_liability_amount

    @merchant_chain_liability_amount.setter
    def merchant_chain_liability_amount(self, merchant_chain_liability_amount):
        """Sets the merchant_chain_liability_amount of this Receipt.

        The amount that is due on the Chain Liability G-Account (Wet Ketenaansprakelijkheid G-rekening)  # noqa: E501

        :param merchant_chain_liability_amount: The merchant_chain_liability_amount of this Receipt.  # noqa: E501
        :type: int
        """

        self._merchant_chain_liability_amount = merchant_chain_liability_amount
    ...
    def vat_context(self, vat_context):
        ...
        :type: str
        """
        allowed_values = ["", "purchase_none", "vat_eu", "vat_reverse_charged", "vat_exempted", "vat_margin"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and vat_context not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `vat_context` ({0}), must be one of {1}"  # noqa: E501
                .format(vat_context, allowed_values)
            )
