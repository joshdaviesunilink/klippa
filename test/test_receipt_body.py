...
from klippa_ocr_api.models.receipt_body import ReceiptBody  # noqa: E501
from klippa_ocr_api.rest import ApiException

class TestReceiptBody(unittest.TestCase):
    """ReceiptBody unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = klippa_ocr_api.models.receipt_body.ReceiptBody()  # noqa: E501
        if include_optional :
            return ReceiptBody(
                data = klippa_ocr_api.models.receipt.Receipt(
                    amount = 56, 
                    amount_change = 56, 
                    amount_shipping = 56, 
                    amountexvat = 56, 
                    barcodes = [
                        klippa_ocr_api.models.barcode.Barcode(
                            type = '', 
                            value = '0', )
                        ], 
                    currency = '0', 
                    customer_address = '0', 
                    customer_bank_account_number = '0', 
                    customer_bank_account_number_bic = '0', 
                    customer_city = '0', 
                    customer_coc_number = '0', 
                    customer_country = '0', 
                    customer_email = '0', 
                    customer_house_number = '0', 
                    customer_municipality = '0', 
                    customer_name = '0', 
                    customer_number = '0', 
                    customer_phone = '0', 
                    customer_province = '0', 
                    customer_reference = '0', 
                    customer_street_name = '0', 
                    customer_vat_number = '0', 
                    customer_website = '0', 
                    customer_zipcode = '0', 
                    date = '0', 
                    document_language = '0', 
                    ...
                    invoice_type = '', 
                    lines = [
                        klippa_ocr_api.models.receipt_line_item.ReceiptLineItem(
                            description = '0', 
                            lineitems = [
                                klippa_ocr_api.models.receipt_line_item_item.ReceiptLineItemItem(
                                    amount = 56, 
                                    amount_each = 56, 
                                    amount_ex_vat = 56, 
                                    description = '0', 
                    ...
                    matched_keywords = [
                        klippa_ocr_api.models.matched_keyword.MatchedKeyword(
                            count = 56, 
                            id = '0', 
                            matches = [
                                '0'
                    ...
                    matched_lineitems = [
                        klippa_ocr_api.models.matched_line_items_receipt.MatchedLineItemsReceipt(
                            id = '0', )
                        ], 
                    matched_purchase_order_id = '0', 
                    merchant_address = '0', 
                    merchant_bank_account_number = '0', 
                    merchant_bank_account_number_bic = '0', 
                    merchant_bank_domestic_account_number = '0', 
                    merchant_bank_domestic_bank_code = '0', 
                    merchant_chain_liability_amount = 56, 
                    merchant_chain_liability_bank_account_number = '0', 
                    merchant_city = '0', 
                    merchant_coc_number = '0', 
                    merchant_country = '0', 
                    merchant_country_code = '0', 
                    merchant_email = '0', 
                    merchant_house_number = '0', 
                    merchant_id = '0', 
                    merchant_main_activity_code = '0', 
                    merchant_municipality = '0', 
                    merchant_name = '0', 
                    merchant_phone = '0', 
                    merchant_province = '0', 
                    merchant_street_name = '0', 
                    merchant_vat_number = '0', 
                    merchant_website = '0', 
                    merchant_zipcode = '0', 
                    order_number = '0', 
                    package_number = '0', 
                    payment_auth_code = '0', 
                    payment_card_account_number = '0', 
                    payment_card_bank = '0', 
                    payment_card_issuer = '0', 
                    payment_card_number = '0', 
                    payment_due_date = '0', 
                    payment_slip_code = '0', 
                    payment_slip_customer_number = '0', 
                    payment_slip_reference_number = '0', 
                    paymentmethod = '', 
                    purchasedate = '0', 
                    purchasetime = '0', 
                    raw_text = '0', 
                    ...
                    vatamount = 56, 
                    vatitems = [
                        klippa_ocr_api.models.receipt_vat.ReceiptVAT(
                            amount = 56, 
                            amount_excl_vat = 56, 
