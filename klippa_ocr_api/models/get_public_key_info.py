...
class GetPublicKeyInfo(object):
    ...
    def __init__(self, available_scans=None, id=None, is_valid=None, scan_limit=None, used_scans=None, valid_until=None, local_vars_configuration=None):  # noqa: E501
        """GetPublicKeyInfo - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._available_scans = None
        self._id = None
        self._is_valid = None
        self._scan_limit = None
        self._used_scans = None
        self._valid_until = None
        self.discriminator = None

        if available_scans is not None:
    ...
    def available_scans(self):
        """Gets the available_scans of this GetPublicKeyInfo.  # noqa: E501

        The number of used scans.  # noqa: E501

        :return: The available_scans of this GetPublicKeyInfo.  # noqa: E501
        :rtype: int
        """
        return self._available_scans

    @available_scans.setter
    def available_scans(self, available_scans):
        """Sets the available_scans of this GetPublicKeyInfo.

        The number of used scans.  # noqa: E501

        :param available_scans: The available_scans of this GetPublicKeyInfo.  # noqa: E501
        :type: int
        """

        self._available_scans = available_scans

    @property
    def id(self):
        """Gets the id of this GetPublicKeyInfo.  # noqa: E501

        The ID of the public key.  # noqa: E501

        :return: The id of this GetPublicKeyInfo.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this GetPublicKeyInfo.

        The ID of the public key.  # noqa: E501

        :param id: The id of this GetPublicKeyInfo.  # noqa: E501
        :type: int
        """
    ...
    @property
    def is_valid(self):
        """Gets the is_valid of this GetPublicKeyInfo.  # noqa: E501

        Whether the public key is valid at this moment.  # noqa: E501

        :return: The is_valid of this GetPublicKeyInfo.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_valid(self, is_valid):
        """Sets the is_valid of this GetPublicKeyInfo.

        Whether the public key is valid at this moment.  # noqa: E501

        :param is_valid: The is_valid of this GetPublicKeyInfo.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def scan_limit(self):
        """Gets the scan_limit of this GetPublicKeyInfo.  # noqa: E501

        How many scans the public key can do.  # noqa: E501

        :return: The scan_limit of this GetPublicKeyInfo.  # noqa: E501
        :rtype: int
        """
        return self._scan_limit

    @scan_limit.setter
    def scan_limit(self, scan_limit):
        """Sets the scan_limit of this GetPublicKeyInfo.

        How many scans the public key can do.  # noqa: E501

        :param scan_limit: The scan_limit of this GetPublicKeyInfo.  # noqa: E501
        :type: int
        """
    ...
    @property
    def used_scans(self):
        """Gets the used_scans of this GetPublicKeyInfo.  # noqa: E501

        The number of used scans.  # noqa: E501

        :return: The used_scans of this GetPublicKeyInfo.  # noqa: E501
        :rtype: int
        """
        return self._used_scans

    @used_scans.setter
    def used_scans(self, used_scans):
        """Sets the used_scans of this GetPublicKeyInfo.

        The number of used scans.  # noqa: E501

        :param used_scans: The used_scans of this GetPublicKeyInfo.  # noqa: E501
        :type: int
        """

        self._used_scans = used_scans

    @property
    def valid_until(self):
        """Gets the valid_until of this GetPublicKeyInfo.  # noqa: E501

        When the public key expires.  # noqa: E501

        :return: The valid_until of this GetPublicKeyInfo.  # noqa: E501
        :rtype: datetime
        """
    ...
    def valid_until(self, valid_until):
        """Sets the valid_until of this GetPublicKeyInfo.

        When the public key expires.  # noqa: E501

        :param valid_until: The valid_until of this GetPublicKeyInfo.  # noqa: E501
        :type: datetime
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetPublicKeyInfo):
            return False
