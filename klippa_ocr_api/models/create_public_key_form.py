...
class CreatePublicKeyForm(object):
    ...
    def __init__(self, external_id=None, scan_limit=None, valid_time=None, local_vars_configuration=None):  # noqa: E501
        """CreatePublicKeyForm - a model defined in OpenAPI"""  # noqa: E501
    ...
    def external_id(self):
        """Gets the external_id of this CreatePublicKeyForm.  # noqa: E501


        :return: The external_id of this CreatePublicKeyForm.  # noqa: E501
        :rtype: str
        """
    ...
    def external_id(self, external_id):
        """Sets the external_id of this CreatePublicKeyForm.


        :param external_id: The external_id of this CreatePublicKeyForm.  # noqa: E501
        :type: str
        """
    ...
    @property
    def scan_limit(self):
        """Gets the scan_limit of this CreatePublicKeyForm.  # noqa: E501

        The amount of scans the public key can do.  # noqa: E501

        :return: The scan_limit of this CreatePublicKeyForm.  # noqa: E501
        :rtype: int
        """
    ...
    def scan_limit(self, scan_limit):
        """Sets the scan_limit of this CreatePublicKeyForm.

        The amount of scans the public key can do.  # noqa: E501

        :param scan_limit: The scan_limit of this CreatePublicKeyForm.  # noqa: E501
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and scan_limit is None:  # noqa: E501
            raise ValueError("Invalid value for `scan_limit`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                scan_limit is not None and scan_limit > 100):  # noqa: E501
            raise ValueError("Invalid value for `scan_limit`, must be a value less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                scan_limit is not None and scan_limit < 1):  # noqa: E501
            raise ValueError("Invalid value for `scan_limit`, must be a value greater than or equal to `1`")  # noqa: E501

        self._scan_limit = scan_limit

    @property
    def valid_time(self):
        """Gets the valid_time of this CreatePublicKeyForm.  # noqa: E501

        The amount of seconds the public key should be valid. With a minimum of 1 minute (60) and a maximum of 1 hour (3600).  # noqa: E501

        :return: The valid_time of this CreatePublicKeyForm.  # noqa: E501
        :rtype: int
        """
    ...
    def valid_time(self, valid_time):
        """Sets the valid_time of this CreatePublicKeyForm.

        The amount of seconds the public key should be valid. With a minimum of 1 minute (60) and a maximum of 1 hour (3600).  # noqa: E501

        :param valid_time: The valid_time of this CreatePublicKeyForm.  # noqa: E501
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and valid_time is None:  # noqa: E501
            raise ValueError("Invalid value for `valid_time`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                valid_time is not None and valid_time > 3600):  # noqa: E501
            raise ValueError("Invalid value for `valid_time`, must be a value less than or equal to `3600`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                valid_time is not None and valid_time < 60):  # noqa: E501
            raise ValueError("Invalid value for `valid_time`, must be a value greater than or equal to `60`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreatePublicKeyForm):
            return False
