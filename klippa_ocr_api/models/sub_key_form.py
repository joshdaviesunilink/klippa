...
class SubKeyForm(object):
    ...
    def __init__(self, name=None, public_keys=None, status=None, templates=None, user_data_sets=None, local_vars_configuration=None):  # noqa: E501
        """SubKeyForm - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this SubKeyForm.  # noqa: E501

        The name of the sub key  # noqa: E501

        :return: The name of this SubKeyForm.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SubKeyForm.

        The name of the sub key  # noqa: E501

        :param name: The name of this SubKeyForm.  # noqa: E501
        :type: str
        """
    ...
    def public_keys(self):
        """Gets the public_keys of this SubKeyForm.  # noqa: E501

        Whether the sub key can use public keys. Note that the parent key must also be able to do this.  # noqa: E501

        :return: The public_keys of this SubKeyForm.  # noqa: E501
        :rtype: bool
        """
    ...
    def public_keys(self, public_keys):
        """Sets the public_keys of this SubKeyForm.

        Whether the sub key can use public keys. Note that the parent key must also be able to do this.  # noqa: E501

        :param public_keys: The public_keys of this SubKeyForm.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def status(self):
        """Gets the status of this SubKeyForm.  # noqa: E501

        The status of the sub key.  # noqa: E501

        :return: The status of this SubKeyForm.  # noqa: E501
        :rtype: bool
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this SubKeyForm.

        The status of the sub key.  # noqa: E501

        :param status: The status of this SubKeyForm.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def templates(self):
        """Gets the templates of this SubKeyForm.  # noqa: E501

        A list of template keys that the key can use. Note that the parent key must have access to it.  # noqa: E501

        :return: The templates of this SubKeyForm.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def templates(self, templates):
        """Sets the templates of this SubKeyForm.

        A list of template keys that the key can use. Note that the parent key must have access to it.  # noqa: E501

        :param templates: The templates of this SubKeyForm.  # noqa: E501
        :type: list[str]
        """
    ...
    def user_data_sets(self):
        """Gets the user_data_sets of this SubKeyForm.  # noqa: E501

        Whether the sub key can use user data sets. Note that the parent key must also be able to do this.  # noqa: E501

        :return: The user_data_sets of this SubKeyForm.  # noqa: E501
        :rtype: bool
        """
    ...
    def user_data_sets(self, user_data_sets):
        """Sets the user_data_sets of this SubKeyForm.

        Whether the sub key can use user data sets. Note that the parent key must also be able to do this.  # noqa: E501

        :param user_data_sets: The user_data_sets of this SubKeyForm.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubKeyForm):
            return False
