...
from klippa_ocr_api.models.european_passport_body import EuropeanPassportBody  # noqa: E501
from klippa_ocr_api.rest import ApiException

class TestEuropeanPassportBody(unittest.TestCase):
    """EuropeanPassportBody unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = klippa_ocr_api.models.european_passport_body.EuropeanPassportBody()  # noqa: E501
        if include_optional :
            return EuropeanPassportBody(
                data = klippa_ocr_api.models.european_passport.EuropeanPassport(
                    authority = '0', 
                    date_of_birth = '0', 
                    date_of_expiry = '0', 
                    date_of_issue = '0', 
    ...
    def testEuropeanPassportBody(self):
        """Test EuropeanPassportBody"""
