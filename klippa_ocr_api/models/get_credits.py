...
class GetCredits(object):
    ...
    def __init__(self, available_credits=None, spendable_credits=None, used_credits=None, uses_credit_system=None, local_vars_configuration=None):  # noqa: E501
        """GetCredits - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._available_credits = None
        self._spendable_credits = None
        self._used_credits = None
        self._uses_credit_system = None
        self.discriminator = None

        if available_credits is not None:
            self.available_credits = available_credits
        if spendable_credits is not None:
            self.spendable_credits = spendable_credits
        if used_credits is not None:
            self.used_credits = used_credits
        if uses_credit_system is not None:
            self.uses_credit_system = uses_credit_system

    @property
    def available_credits(self):
        """Gets the available_credits of this GetCredits.  # noqa: E501

        The total number of credits that were added to your account.  # noqa: E501

        :return: The available_credits of this GetCredits.  # noqa: E501
        :rtype: int
        """
    ...
    def available_credits(self, available_credits):
        """Sets the available_credits of this GetCredits.

        The total number of credits that were added to your account.  # noqa: E501

        :param available_credits: The available_credits of this GetCredits.  # noqa: E501
        :type: int
        """
    ...
    def spendable_credits(self):
        """Gets the spendable_credits of this GetCredits.  # noqa: E501

        The number of credits that are available to spend. Please note that this can be lower than 0 if you are in the overdraw period (10% of credits).  # noqa: E501

        :return: The spendable_credits of this GetCredits.  # noqa: E501
        :rtype: int
        """
        return self._spendable_credits

    @spendable_credits.setter
    def spendable_credits(self, spendable_credits):
        """Sets the spendable_credits of this GetCredits.

        The number of credits that are available to spend. Please note that this can be lower than 0 if you are in the overdraw period (10% of credits).  # noqa: E501

        :param spendable_credits: The spendable_credits of this GetCredits.  # noqa: E501
        :type: int
        """

        self._spendable_credits = spendable_credits

    @property
    def used_credits(self):
        """Gets the used_credits of this GetCredits.  # noqa: E501

        The number of spent credits.  # noqa: E501

        :return: The used_credits of this GetCredits.  # noqa: E501
        :rtype: int
        """
    ...
    def used_credits(self, used_credits):
        """Sets the used_credits of this GetCredits.

        The number of spent credits.  # noqa: E501

        :param used_credits: The used_credits of this GetCredits.  # noqa: E501
        :type: int
        """
    ...
    @property
    def uses_credit_system(self):
        """Gets the uses_credit_system of this GetCredits.  # noqa: E501

        Whether this key actually uses the credit system.  # noqa: E501

        :return: The uses_credit_system of this GetCredits.  # noqa: E501
        :rtype: bool
        """
        return self._uses_credit_system

    @uses_credit_system.setter
    def uses_credit_system(self, uses_credit_system):
        """Sets the uses_credit_system of this GetCredits.

        Whether this key actually uses the credit system.  # noqa: E501

        :param uses_credit_system: The uses_credit_system of this GetCredits.  # noqa: E501
        :type: bool
        """

        self._uses_credit_system = uses_credit_system
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetCredits):
            return False
