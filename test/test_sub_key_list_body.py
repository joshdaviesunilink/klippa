...
from klippa_ocr_api.models.sub_key_list_body import SubKeyListBody  # noqa: E501
from klippa_ocr_api.rest import ApiException

class TestSubKeyListBody(unittest.TestCase):
    """SubKeyListBody unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = klippa_ocr_api.models.sub_key_list_body.SubKeyListBody()  # noqa: E501
        if include_optional :
            return SubKeyListBody(
                data = klippa_ocr_api.models.sub_keys.subKeys(
                    count = 56, 
                    more_results = True, 
                    page = 56, 
                    pages = 56, 
                    ...
                    sub_keys = [
                        klippa_ocr_api.models.key.Key(
                            ...
                            status = True, 
                            templates = [
                                klippa_ocr_api.models.template.Template(
                                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                                    deleted_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                                    id = 56, 
                                    status = True, 
