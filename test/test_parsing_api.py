...
from klippa_ocr_api.api.parsing_api import ParsingApi  # noqa: E501
from klippa_ocr_api.rest import ApiException


class TestParsingApi(unittest.TestCase):
    """ParsingApi unit test stubs"""

    def setUp(self):
        self.api = klippa_ocr_api.api.parsing_api.ParsingApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_parse_document(self):
        """Test case for parse_document

        Template Financial (default): Parse GIF, PNG, JPG, HEIC/HEIF or PDF file.  # noqa: E501
        """
        pass

    def test_parse_document_eu_passport(self):
        """Test case for parse_document_eu_passport

        Template EU Passport: Parse GIF, PNG, JPG, HEIC/HEIF or PDF file.  # noqa: E501
        """
        pass

    def test_parse_document_identity_document(self):
        """Test case for parse_document_identity_document

        Template Identity Document: Parse GIF, PNG, JPG, HEIC/HEIF or PDF file.  # noqa: E501
        """
        pass

    def test_parse_structured_pdf(self):
        """Test case for parse_structured_pdf
