...
class CreateUserDataSetForm(object):
    ...
    def __init__(self, external_id=None, last_sync_date=None, type=None, local_vars_configuration=None):  # noqa: E501
        """CreateUserDataSetForm - a model defined in OpenAPI"""  # noqa: E501
    ...
    def external_id(self):
        """Gets the external_id of this CreateUserDataSetForm.  # noqa: E501

        The ID on the external user this data set belongs to.  # noqa: E501

        :return: The external_id of this CreateUserDataSetForm.  # noqa: E501
        :rtype: str
        """
    ...
    def external_id(self, external_id):
        """Sets the external_id of this CreateUserDataSetForm.

        The ID on the external user this data set belongs to.  # noqa: E501

        :param external_id: The external_id of this CreateUserDataSetForm.  # noqa: E501
        :type: str
        """
    ...
    def last_sync_date(self):
        """Gets the last_sync_date of this CreateUserDataSetForm.  # noqa: E501

        The last sync date to keep track when you last updated this set. We advice to make this date equal to the last update date on the external side. Must be in RFC3339 format.  # noqa: E501

        :return: The last_sync_date of this CreateUserDataSetForm.  # noqa: E501
        :rtype: datetime
        """
    ...
    def last_sync_date(self, last_sync_date):
        """Sets the last_sync_date of this CreateUserDataSetForm.

        The last sync date to keep track when you last updated this set. We advice to make this date equal to the last update date on the external side. Must be in RFC3339 format.  # noqa: E501

        :param last_sync_date: The last_sync_date of this CreateUserDataSetForm.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def type(self):
        """Gets the type of this CreateUserDataSetForm.  # noqa: E501

        The type of the data set.  # noqa: E501

        :return: The type of this CreateUserDataSetForm.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this CreateUserDataSetForm.

        The type of the data set.  # noqa: E501

        :param type: The type of this CreateUserDataSetForm.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and type is None:  # noqa: E501
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["relation", "transaction", "product", "building", "purchase_order"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateUserDataSetForm):
            return False
