...
class GetTemplates(object):
    ...
    """
    openapi_types = {
        'templates': 'dict(str, RespTemplate)'
    }
    ...
    def __init__(self, templates=None, local_vars_configuration=None):  # noqa: E501
        """GetTemplates - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def templates(self):
        """Gets the templates of this GetTemplates.  # noqa: E501


        :return: The templates of this GetTemplates.  # noqa: E501
        :rtype: dict(str, RespTemplate)
        """
        return self._templates

    @templates.setter
    def templates(self, templates):
        """Sets the templates of this GetTemplates.


        :param templates: The templates of this GetTemplates.  # noqa: E501
        :type: dict(str, RespTemplate)
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetTemplates):
            return False
