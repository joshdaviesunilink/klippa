...
class UpdateUserDataSetRecordForm(object):
    ...
    def __init__(self, last_sync_date=None, values=None, local_vars_configuration=None):  # noqa: E501
        """UpdateUserDataSetRecordForm - a model defined in OpenAPI"""  # noqa: E501
    ...
    def last_sync_date(self):
        """Gets the last_sync_date of this UpdateUserDataSetRecordForm.  # noqa: E501
        ...
        :return: The last_sync_date of this UpdateUserDataSetRecordForm.  # noqa: E501
        :rtype: datetime
        """
    ...
    def last_sync_date(self, last_sync_date):
        """Sets the last_sync_date of this UpdateUserDataSetRecordForm.

        The last sync date to keep track when you last updated this set record. We advice to make this date equal to the last update date on the external side. Must be in RFC3339 format.  # noqa: E501

        :param last_sync_date: The last_sync_date of this UpdateUserDataSetRecordForm.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def values(self):
        """Gets the values of this UpdateUserDataSetRecordForm.  # noqa: E501

        The values that belong to this record. The available values differ per set type.  # noqa: E501

        :return: The values of this UpdateUserDataSetRecordForm.  # noqa: E501
    ...
    def values(self, values):
        """Sets the values of this UpdateUserDataSetRecordForm.

        The values that belong to this record. The available values differ per set type.  # noqa: E501

        :param values: The values of this UpdateUserDataSetRecordForm.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateUserDataSetRecordForm):
            return False
