...
class TextUploadForm(object):
    ...
    """
    openapi_types = {
        'hash_duplicate_group_id': 'str',
        'template': 'str',
        'text': 'str',
        'user_data': 'str',
        'user_data_set_external_id': 'str'
    }

    attribute_map = {
        'hash_duplicate_group_id': 'hash_duplicate_group_id',
        'template': 'template',
        'text': 'text',
        'user_data': 'user_data',
        'user_data_set_external_id': 'user_data_set_external_id'
    }

    def __init__(self, hash_duplicate_group_id=None, template=None, text=None, user_data=None, user_data_set_external_id=None, local_vars_configuration=None):  # noqa: E501
        """TextUploadForm - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._hash_duplicate_group_id = None
        self._template = None
        self._text = None
        self._user_data = None
        self._user_data_set_external_id = None
        self.discriminator = None

        if hash_duplicate_group_id is not None:
            self.hash_duplicate_group_id = hash_duplicate_group_id
        ...
        if user_data_set_external_id is not None:
            self.user_data_set_external_id = user_data_set_external_id

    @property
    def hash_duplicate_group_id(self):
        """Gets the hash_duplicate_group_id of this TextUploadForm.  # noqa: E501

        An identifier to use when saving/detecting hash duplicates. This way you can allow to have the same document scanned more than once for multiple groups. When doing a scan, the combination of the Hash Group ID and the document Hash will be used to detect duplicates. This value is saved hashed on our side. Common use cases: Company ID, Campaign ID, User ID. In: formData  # noqa: E501

        :return: The hash_duplicate_group_id of this TextUploadForm.  # noqa: E501
        :rtype: str
        """
        return self._hash_duplicate_group_id

    @hash_duplicate_group_id.setter
    def hash_duplicate_group_id(self, hash_duplicate_group_id):
        """Sets the hash_duplicate_group_id of this TextUploadForm.

        An identifier to use when saving/detecting hash duplicates. This way you can allow to have the same document scanned more than once for multiple groups. When doing a scan, the combination of the Hash Group ID and the document Hash will be used to detect duplicates. This value is saved hashed on our side. Common use cases: Company ID, Campaign ID, User ID. In: formData  # noqa: E501

        :param hash_duplicate_group_id: The hash_duplicate_group_id of this TextUploadForm.  # noqa: E501
        :type: str
        """

        self._hash_duplicate_group_id = hash_duplicate_group_id

    @property
    def template(self):
        """Gets the template of this TextUploadForm.  # noqa: E501


        :return: The template of this TextUploadForm.  # noqa: E501
        :rtype: str
        """
    ...
    def template(self, template):
        """Sets the template of this TextUploadForm.


        :param template: The template of this TextUploadForm.  # noqa: E501
        :type: str
        """
    ...
    @property
    def text(self):
        """Gets the text of this TextUploadForm.  # noqa: E501


        :return: The text of this TextUploadForm.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this TextUploadForm.


        :param text: The text of this TextUploadForm.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_data(self):
        """Gets the user_data of this TextUploadForm.  # noqa: E501

        Extra metadata to give to the parser. Only works with templates that are configured to accept user data.  # noqa: E501

        :return: The user_data of this TextUploadForm.  # noqa: E501
        :rtype: str
        """
    ...
    def user_data(self, user_data):
        """Sets the user_data of this TextUploadForm.

        Extra metadata to give to the parser. Only works with templates that are configured to accept user data.  # noqa: E501

        :param user_data: The user_data of this TextUploadForm.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_data_set_external_id(self):
        """Gets the user_data_set_external_id of this TextUploadForm.  # noqa: E501

        The external ID of the user data set.  # noqa: E501

        :return: The user_data_set_external_id of this TextUploadForm.  # noqa: E501
        :rtype: str
        """
        return self._user_data_set_external_id

    @user_data_set_external_id.setter
    def user_data_set_external_id(self, user_data_set_external_id):
        """Sets the user_data_set_external_id of this TextUploadForm.

        The external ID of the user data set.  # noqa: E501

        :param user_data_set_external_id: The user_data_set_external_id of this TextUploadForm.  # noqa: E501
        :type: str
        """

        self._user_data_set_external_id = user_data_set_external_id
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TextUploadForm):
            return False
