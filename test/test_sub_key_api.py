...
from klippa_ocr_api.api.sub_key_api import SubKeyApi  # noqa: E501
...
class TestSubKeyApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = klippa_ocr_api.api.sub_key_api.SubKeyApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_create_sub_key(self):
    ...
    def test_sub_key_list(self):
        """Test case for sub_key_list

        Get a list of sub keys.  # noqa: E501
        """
        pass

    def test_sub_key_statistics(self):
        """Test case for sub_key_statistics

        Get API usage statistics for the sub key.  # noqa: E501
        """
        pass

    def test_update_sub_key(self):
