...
from klippa_ocr_api.api.user_data_sets_api import UserDataSetsApi  # noqa: E501
from klippa_ocr_api.rest import ApiException


class TestUserDataSetsApi(unittest.TestCase):
    """UserDataSetsApi unit test stubs"""

    def setUp(self):
        self.api = klippa_ocr_api.api.user_data_sets_api.UserDataSetsApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_bulk_user_data_set_record(self):
        """Test case for bulk_user_data_set_record

        Bulk create/update/delete user data set record.  # noqa: E501
        """
        pass

    def test_create_user_data_set(self):
        """Test case for create_user_data_set

        Create a new user data set.  # noqa: E501
        """
        pass

    def test_create_user_data_set_record(self):
        """Test case for create_user_data_set_record

        Create a new user data set record.  # noqa: E501
        """
        pass

    def test_delete_user_data_set(self):
        """Test case for delete_user_data_set

        Delete user data set.  # noqa: E501
        """
        pass

    def test_delete_user_data_set_record(self):
        """Test case for delete_user_data_set_record

        Delete user data set record.  # noqa: E501
        """
        pass

    def test_get_user_data_set(self):
        """Test case for get_user_data_set

        Get user data set.  # noqa: E501
        """
        pass

    def test_get_user_data_set_record(self):
        """Test case for get_user_data_set_record

        Get user data set record.  # noqa: E501
        """
        pass

    def test_get_user_data_set_records(self):
        """Test case for get_user_data_set_records

        List user data set records.  # noqa: E501
        """
        pass

    def test_get_user_data_sets(self):
        """Test case for get_user_data_sets

        List user data sets.  # noqa: E501
        """
        pass

    def test_update_user_data_set(self):
        """Test case for update_user_data_set

        Update user data set.  # noqa: E501
        """
        pass

    def test_update_user_data_set_record(self):
        """Test case for update_user_data_set_record
