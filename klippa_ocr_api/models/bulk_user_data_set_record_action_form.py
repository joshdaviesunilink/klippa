...
class BulkUserDataSetRecordActionForm(object):
    ...
    openapi_types = {
        ...
        'values': 'list[UserDataSetRecordValueForm]'
    }
    ...
    def __init__(self, action=None, external_id=None, last_sync_date=None, values=None, local_vars_configuration=None):  # noqa: E501
        """BulkUserDataSetRecordActionForm - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def action(self):
        """Gets the action of this BulkUserDataSetRecordActionForm.  # noqa: E501

        The action to perform.  # noqa: E501

        :return: The action of this BulkUserDataSetRecordActionForm.  # noqa: E501
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        """Sets the action of this BulkUserDataSetRecordActionForm.

        The action to perform.  # noqa: E501

        :param action: The action of this BulkUserDataSetRecordActionForm.  # noqa: E501
        :type: str
        """
    ...
    def external_id(self):
        """Gets the external_id of this BulkUserDataSetRecordActionForm.  # noqa: E501

        The ID on the external user record this data set belongs to.  # noqa: E501

        :return: The external_id of this BulkUserDataSetRecordActionForm.  # noqa: E501
        :rtype: str
        """
    ...
    def external_id(self, external_id):
        """Sets the external_id of this BulkUserDataSetRecordActionForm.

        The ID on the external user record this data set belongs to.  # noqa: E501

        :param external_id: The external_id of this BulkUserDataSetRecordActionForm.  # noqa: E501
        :type: str
        """
    ...
    def last_sync_date(self):
        """Gets the last_sync_date of this BulkUserDataSetRecordActionForm.  # noqa: E501

        The last sync date to keep track when you last updated this set record. We advice to make this date equal to the last update date on the external side. Must be in RFC3339 format.  # noqa: E501

        :return: The last_sync_date of this BulkUserDataSetRecordActionForm.  # noqa: E501
        :rtype: datetime
        """
    ...
    def last_sync_date(self, last_sync_date):
        """Sets the last_sync_date of this BulkUserDataSetRecordActionForm.

        The last sync date to keep track when you last updated this set record. We advice to make this date equal to the last update date on the external side. Must be in RFC3339 format.  # noqa: E501

        :param last_sync_date: The last_sync_date of this BulkUserDataSetRecordActionForm.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def values(self):
        """Gets the values of this BulkUserDataSetRecordActionForm.  # noqa: E501

        The values that belong to this record. The available values differ per set type.  # noqa: E501

        :return: The values of this BulkUserDataSetRecordActionForm.  # noqa: E501
        :rtype: list[UserDataSetRecordValueForm]
        """
        return self._values

    @values.setter
    def values(self, values):
        """Sets the values of this BulkUserDataSetRecordActionForm.

        The values that belong to this record. The available values differ per set type.  # noqa: E501

        :param values: The values of this BulkUserDataSetRecordActionForm.  # noqa: E501
        :type: list[UserDataSetRecordValueForm]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkUserDataSetRecordActionForm):
            return False
