...
from klippa_ocr_api.models.bulk_user_data_set_record_form import BulkUserDataSetRecordForm  # noqa: E501
from klippa_ocr_api.rest import ApiException

class TestBulkUserDataSetRecordForm(unittest.TestCase):
    """BulkUserDataSetRecordForm unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test BulkUserDataSetRecordForm
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = klippa_ocr_api.models.bulk_user_data_set_record_form.BulkUserDataSetRecordForm()  # noqa: E501
        if include_optional :
            return BulkUserDataSetRecordForm(
                actions = [
                    klippa_ocr_api.models.bulk_user_data_set_record_action_form.bulkUserDataSetRecordActionForm(
                        action = 'create', 
                        external_id = '0', 
                        last_sync_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        values = [
                            klippa_ocr_api.models.user_data_set_record_value_form.userDataSetRecordValueForm(
                                name = '0', 
                                value = '0', )
                            ], )
                    ]
    ...
    def testBulkUserDataSetRecordForm(self):
        """Test BulkUserDataSetRecordForm"""
