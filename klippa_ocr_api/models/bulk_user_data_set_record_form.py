...
class BulkUserDataSetRecordForm(object):
    ...
    """
    openapi_types = {
        'actions': 'list[BulkUserDataSetRecordActionForm]'
    }
    ...
    def __init__(self, actions=None, local_vars_configuration=None):  # noqa: E501
        """BulkUserDataSetRecordForm - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def actions(self):
        """Gets the actions of this BulkUserDataSetRecordForm.  # noqa: E501

        A set of actions, with a maximum of 1000 actions in 1 call.  # noqa: E501

        :return: The actions of this BulkUserDataSetRecordForm.  # noqa: E501
        :rtype: list[BulkUserDataSetRecordActionForm]
        """
        return self._actions

    @actions.setter
    def actions(self, actions):
        """Sets the actions of this BulkUserDataSetRecordForm.

        A set of actions, with a maximum of 1000 actions in 1 call.  # noqa: E501

        :param actions: The actions of this BulkUserDataSetRecordForm.  # noqa: E501
        :type: list[BulkUserDataSetRecordActionForm]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkUserDataSetRecordForm):
            return False
